...
def parse_args():
    ...
    parser.add_argument("--total_epoch", type=int, default=50, help="# of epochs")
    ...
    parser.add_argument(
        ...
        default="gender,race_enc,admission_type_enc,admission_location_enc,discharge_location_enc,insurance,language,marital_status_enc,event",
    ...
    parser.add_argument("--train-data", type=str, default="train_test_2_200k.tsv")
    parser.add_argument("--val-data", type=str, default="val_test_2_200k.tsv")
    parser.add_argument("--test-data", type=str, default="test_test_2_200k.tsv")
    ...
    parser.add_argument("--exp_name", type=str, default="03171100_fixedUpdatedReward")
